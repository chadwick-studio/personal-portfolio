...
const css$1 = {
  code: '@font-face{font-family:"Yard Sale";src:url("/fonts/yard_sale/yardsale.woff2") format("woff2")}.menu_toggle-button.svelte-1u9xmkn.svelte-1u9xmkn{aspect-ratio:1;width:3rem;position:fixed;z-index:10;bottom:24px;right:24px;mix-blend-mode:difference}.menu_toggle-button.svelte-1u9xmkn.svelte-1u9xmkn,.menu_toggle-button.svelte-1u9xmkn svg.svelte-1u9xmkn{display:block}.menu_toggle-button.svelte-1u9xmkn.svelte-1u9xmkn:focus-visible{outline:2px solid #ffd436}.menu-icon_circles.svelte-1u9xmkn.svelte-1u9xmkn{fill:#ffd436}.menu_navigation.svelte-1u9xmkn.svelte-1u9xmkn{display:flex;flex-direction:column;justify-content:end;position:fixed;bottom:0;right:0;height:100vh;height:100vh;border-left:2px solid black;background-color:#ffd436;transform:translate3d(calc(var(--translateX) * 100%), 0, 0)}.navigation-list.svelte-1u9xmkn.svelte-1u9xmkn{display:flex;color:black;flex-direction:column;font-size:0.615rem;font-family:"Yard Sale";text-transform:uppercase;text-align:right;margin-bottom:96px;margin-inline:24px}.navigation-list.svelte-1u9xmkn a.svelte-1u9xmkn{display:inline-block;position:relative}.navigation-list.svelte-1u9xmkn a.svelte-1u9xmkn::before{content:"";display:block;position:absolute;top:0;right:-0.8em;width:0.25em;height:0%;transition:height 150ms;background-color:#9c0087}.navigation-list.svelte-1u9xmkn a.svelte-1u9xmkn:active{top:1px}.navigation-list.svelte-1u9xmkn a.svelte-1u9xmkn:hover::before,.navigation-list.svelte-1u9xmkn a.svelte-1u9xmkn:focus-visible::before{height:80%;transition:height 250ms}li.active.svelte-1u9xmkn.svelte-1u9xmkn{color:#9c0087;transition:color 100ms}',
  map: null
};
const Navigation = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<div class="menu_container"><button class="menu_toggle-button svelte-1u9xmkn"${add_attribute("aria-expanded", menuIsVisible, 0)} aria-controls="navigation"><span class="sr-only">Menu</span>
		<svg version="1.1" width="100%" height="100%" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg" class="menu-icon svelte-1u9xmkn" title="Menu Icon"><filter id="menu-filter" x="-50%" y="-50%" width="200%" height="200%" filterUnits="objectBoundingBox"><feTurbulence type="fractalNoise" baseFrequency="0" result="noise" numOctaves="4" seed="10"></feTurbulence><feDisplacementMap in="SourceGraphic" in2="noise" scale="20" xChannelSelector="G" yChannelSelector="R"></feDisplacementMap></filter><g filter="url(#menu-filter)" class="menu-icon_circles svelte-1u9xmkn" transform="translate(7, 7)" fill="currentColor"><g><circle class="top-left" cx="5" cy="5" r="5"></circle><circle cx="5" cy="18" r="5"></circle><circle class="bottom-left" cx="5" cy="31" r="5"></circle></g><g><circle cx="18" cy="5" r="5"></circle><circle cx="18" cy="31" r="5"></circle></g><g><circle class="top-right" cx="31" cy="5" r="5"></circle><circle cx="31" cy="18" r="5"></circle><circle class="bottom-right" cx="31" cy="31" r="5"></circle></g></g></svg></button>
	<nav id="navigation" aria-label="Menu" class="menu_navigation svelte-1u9xmkn"${add_styles({ "--translateX": $menuTween })}><ul class="navigation-list svelte-1u9xmkn">${each(routeLinks, (link) => {
    return `<li class="${["svelte-1u9xmkn", $page.url.pathname === link[0] ? "active" : ""].join(" ").trim()}"><a${add_attribute("href", link[0], 0)} aria-current="page" class="svelte-1u9xmkn">${escape(link[1])}</a>
				</li>`;
  })}</ul></nav>
</div>`;
});
...
const css = {
  code: 'body{background-color:#ffd436;overflow-x:hidden;scrollbar-width:none;scrollbar-gutter:stable}.page-transition.svelte-1iprkgc{overflow-x:hidden;scrollbar-width:none;scrollbar-gutter:stable}.body_container.svelte-1iprkgc{position:relative;min-height:100vh;min-height:100dvh;background-color:#ffd436}.container{height:100vh;height:100dvh}.header:not(.home){display:flex;align-items:end;font-size:clamp(3.5rem, 3.2143rem + 1.4286vw, 4.5rem);border-bottom:2px solid black;padding-top:24px;padding-left:24px;padding-bottom:24px}.header:is(.home){padding-bottom:24px;padding-left:24px}.title, .subtitle{cursor:default;font-family:"Cooper Hewitt", sans-serif;text-transform:uppercase;line-height:1;white-space:nowrap}.title{font-weight:900;writing-mode:vertical-rl;transform:rotate(180deg)}.subtitle{font-weight:300;font-size:30%;line-height:1.2;transform:translate3d(-0.35em, 0.05em, 0);align-self:end}.container, .main{display:grid}.main{padding-top:48px;padding-bottom:48px;padding-inline:24px;overflow-y:auto;overflow-x:hidden;scrollbar-width:none;scrollbar-gutter:stable}.accent{color:#9c0087}a[href^="https"]::after{content:"";display:inline-block;aspect-ratio:1;width:1em;margin-left:0.25em;background-repeat:no-repeat;background-position:bottom;background-image:url("data:image/svg+xml;base64,");position:relative;top:0.1em}.sr-only{border:0 !important;clip:rect(1px, 1px, 1px, 1px) !important;-webkit-clip-path:inset(50%) !important;clip-path:inset(50%) !important;height:1px !important;margin:-1px !important;overflow:hidden !important;padding:0 !important;position:absolute !important;width:1px !important;white-space:nowrap !important}@media(min-width: 800px){.header:not(.home){border:0;margin:0;padding:0;border-right:2px solid black;padding-bottom:24px;padding-left:24px;padding-right:24px}.container{grid-template-columns:1fr 2fr}.main{margin-top:0;place-items:center;scroll-width:none}}',
  map: null
};
const duration = 300;
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  $$result.css.add(css);
  return `<div class="page-transition body_container svelte-1iprkgc">${slots.default ? slots.default({}) : ``}</div>
