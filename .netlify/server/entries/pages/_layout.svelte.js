...
const css = {
  code: 'body{background-color:#ffd436;overflow-x:hidden;scrollbar-width:thin}.body_container.svelte-xkdy1u{position:relative;min-height:100vh;min-height:100dvh;background-color:#ffd436}.container{height:100vh;height:100dvh}.header:not(.home){display:flex;align-items:end;font-size:clamp(3.5rem, 3.2143rem + 1.4286vw, 4.5rem);border-bottom:2px solid black;padding-top:24px;padding-left:24px;padding-bottom:24px}.title, .subtitle{cursor:default;font-family:"Cooper Hewitt", sans-serif;text-transform:uppercase;line-height:1;white-space:nowrap}.title{font-weight:900;writing-mode:vertical-rl;transform:rotate(180deg)}.subtitle{font-weight:300;font-size:30%;line-height:1.2;transform:translate3d(-0.35em, 0.05em, 0);align-self:end}.container, .main{display:grid}.main{padding-top:48px;padding-bottom:48px;padding-inline:24px;overflow-y:auto;overflow-x:hidden;scrollbar-width:thin}.accent{color:#9c0087}a[href^="https"]::after{content:"";display:inline-block;aspect-ratio:1;width:1em;margin-left:0.25em;background-repeat:no-repeat;background-position:bottom;background-image:url("data:image/svg+xml;base64,");position:relative;top:0.1em}.sr-only{border:0 !important;clip:rect(1px, 1px, 1px, 1px) !important;-webkit-clip-path:inset(50%) !important;clip-path:inset(50%) !important;height:1px !important;margin:-1px !important;overflow:hidden !important;padding:0 !important;position:absolute !important;width:1px !important;white-space:nowrap !important}@media(min-width: 800px){.header{border-right:2px solid black;border-bottom:none;margin:0;padding:0;padding-bottom:24px;padding-left:24px;padding-right:24px}.container{grid-template-columns:1fr 2fr}.main{margin-top:0;place-items:center}}',
  map: null
};
const duration = 300;
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  $$result.css.add(css);
  return `<div class="page-transition"><div class="body_container svelte-xkdy1u">${slots.default ? slots.default({}) : ``}
