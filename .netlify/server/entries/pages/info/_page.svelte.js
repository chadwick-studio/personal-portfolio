...
const css = {
  code: '.description.svelte-1xtre1q p.svelte-1xtre1q.svelte-1xtre1q{font-family:"Tenderness";max-width:60ex;line-height:1.5}.description.svelte-1xtre1q p.svelte-1xtre1q+p.svelte-1xtre1q{text-indent:1em}a.svelte-1xtre1q.svelte-1xtre1q.svelte-1xtre1q{border-bottom:1px solid black}',
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="container"><header class="header"><h1 class="title">Info</h1>
	...
	<main class="main"><div class="description svelte-1xtre1q"><p class="svelte-1xtre1q">I am a web designer and developer based in NYC
			...
			<p class="svelte-1xtre1q">Responsive web design and accessibility are very
			...
			<p class="svelte-1xtre1q">For accessibility, I use semantic HTML, screen
				...
				my colors with <a href="https://webaim.org/resources/contrastchecker/" class="svelte-1xtre1q">WebAIM&#39;s contrast checker</a>, have an option for reduced animations, and
				more to make sure that my website is viewable
				for everyone. If in doubt, I check the
				<a href="https://www.w3.org/WAI/" class="svelte-1xtre1q">Web Accessibility Initiative</a>.
			</p>
			<p class="svelte-1xtre1q">I use Svelte (JavaScript framework) and Sanity
			...
			<p class="svelte-1xtre1q">Let&#39;s create a fun website! You can contact me
