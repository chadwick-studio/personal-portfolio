...
const css = {
  code: '.description.svelte-1e27gg5 p.svelte-1e27gg5.svelte-1e27gg5{font-family:"Tenderness";max-width:60ex}.description.svelte-1e27gg5 p.svelte-1e27gg5+p.svelte-1e27gg5{text-indent:1em}a.svelte-1e27gg5.svelte-1e27gg5.svelte-1e27gg5{border-bottom:1px solid black}',
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="container"><header class="header"><h1 class="title">Info</h1>
	...
	<main class="main"><div class="description svelte-1e27gg5"><p class="svelte-1e27gg5">I am a web designer and developer based in NYC
			...
			<p class="svelte-1e27gg5">Responsive web design and accessibility are very
			...
			<p class="svelte-1e27gg5">For accessibility, I use semantic HTML, screen
				...
				my colors with <a href="https://webaim.org/resources/contrastchecker/" class="svelte-1e27gg5">WebAIM&#39;s contrast checker</a>, have an option for reduced animations, and
				more to make sure that my website is viewable
				for everyone. If in doubt, I check the
				<a href="https://www.w3.org/WAI/" class="svelte-1e27gg5">Web Accessibility Initiative</a>.
			</p>
			<p class="svelte-1e27gg5">I use Svelte (JavaScript framework) and Sanity
			...
			<p class="svelte-1e27gg5">Let&#39;s create a fun website! You can contact me
